...
{
    internal class Octo : IGameObject, IMovable
    {
        ...
        public Octo(Texture2D texture, Ninja target)
        {
            ...
            Speed = new Vector2((float)0.2, (float)0.2);
        ...
        private void Move(double totalseconds)
        {
            ...
            int aniDir = _movementManager.AnimationDirection(this, 3);
